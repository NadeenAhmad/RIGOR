...
![RIGOR Pipeline](figures/LLMOntoRAG_2.png) 
...
│
├── output/                     
│   ├── generated_ontologies/ # Generated ontologies by Direct Mapping (3 ontologies, one per database), Baseline (9 ontologies, 3 databases X 3 LLMs), Non-iterative (9 ontologies, 3 databases X 3 LLMs), RIGOR (9 ontologies, 3 databases X 3 LLMs), Total 30 ontologies   
│
